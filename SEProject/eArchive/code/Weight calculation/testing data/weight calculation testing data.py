...
feature_num=0 
f=open("Testing_Result.txt")
for line in f:
    word=list(line.split())
    result.append(word)   # delete the tweeter_id and result
...
#####   write the weight
w=open("TestingData_Weight.txt",'wb')   # create the weight file, write the weight



for i in range(301, row_data):
