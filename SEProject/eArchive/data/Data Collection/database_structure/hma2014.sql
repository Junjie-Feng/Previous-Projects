...
--
-- Host: localhost
-- Generation Time: 2014-12-13 20:32:51
-- 服务器版本： 5.6.20
-- PHP Version: 5.4.30
...
--
-- 表的结构 `freq_type_count`
--

CREATE TABLE IF NOT EXISTS `freq_type_count` (
  `exercise_type` varchar(20) NOT NULL,
  `screen_name` varchar(50) NOT NULL,
  `exercise_count` int(10) NOT NULL
...
) ENGINE=MyISAM AUTO_INCREMENT=708897 DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `json_cache`
MODIFY `cache_id` int(10) unsigned NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=708897;
